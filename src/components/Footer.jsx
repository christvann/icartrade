...
function Footer() {
  return (
    <div>
      <footer className="bg-white lg:grid lg:grid-cols-5 p-4">
        <div className="relative block h-32 lg:col-span-2 lg:h-full">
          <img
            src="https://www.topgear.com/sites/default/files/cars-car/image/2020/07/dsc09285.jpg"
            alt=""
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-100 pt-12">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-xs text-gray-500 sm:mt-0">&copy; 2024. ICarTrade. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
